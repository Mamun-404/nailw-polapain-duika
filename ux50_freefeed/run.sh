...
# 5M scalping mode: M5 entries with M15 + 4H confirmation.
export EXNESS_TIMEFRAME_MINUTES="5"
export EXNESS_SCAN_SECONDS="300"
export EXNESS_MIN_SIGNAL_CONFIDENCE="85"
export EXNESS_CRYPTO_MIN_CONFIDENCE="85"
export EXNESS_CRYPTO_MIN_RR="1.30"
export EXNESS_MIN_RR="1.30"
export EXNESS_MAX_SPREAD_POINTS="200"
export EXNESS_SIGNAL_COOLDOWN_SECONDS="3600"
export EXNESS_STATUS_EVERY_SECONDS="300"
...
# 12 x 1H candles = 12-hour maximum holding window before expiry-close result.
